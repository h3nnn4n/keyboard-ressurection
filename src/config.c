...
/* 5 */  { KEY_LEFT_CTRL  , KEY_LEFT_GUI , KEY_LEFT_ALT , NOP    , NOP    , NOP    , NOP   , KEY_SPACE , NOP    , NOP       , NOP           , NOP            , NOP             , NOP           , KEY_RIGHT_CTRL  , KEY_LEFT_ARROW , KEY_DOWN_ARROW , KEY_RIGHT_ARROW }
};
