...
/* 2 */  { KEY_TAB        , KEY_Q , KEY_W  , KEY_E  , KEY_R  , KEY_T  , KEY_Y , KEY_U     , KEY_I  , KEY_O     , KEY_P         , KEY_LEFT_BRACE , KEY_RIGHT_BRACE , KEY_BACKSLASH , NOP            , NOP , NOP , NOP  } ,
/* 3 */  { KEY_ESC        , KEY_A , KEY_S  , KEY_D  , KEY_F  , KEY_G  , KEY_H , KEY_J     , KEY_K  , KEY_L     , KEY_SEMICOLON , KEY_QUOTE      , NOP             , NOP           , KEY_ENTER      , NOP , NOP , NOP  } ,
/* 4 */  { KEY_LEFT_SHIFT , NOP   , KEY_Z  , KEY_X  , KEY_C  , KEY_V  , KEY_B , KEY_N     , KEY_M  , KEY_COMMA , KEY_PERIOD    , KEY_SLASH      , NOP             , NOP           , KEY_RIGHT_SHIFT, NOP , NOP , NOP  } ,
/* 5 */  { KEY_LEFT_CTRL  , NOP   , NOP    , NOP    , NOP    , NOP    , NOP   , KEY_SPACE , NOP    , NOP       , NOP           , NOP            , NOP             , NOP           , KEY_RIGHT_CTRL            , NOP , NOP , NOP  }
};
