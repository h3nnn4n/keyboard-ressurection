...
/* 4 */  { NOP       , NOP   , KEY_Z  , KEY_X  , KEY_C  , KEY_V  , KEY_B , KEY_N     , KEY_M  , KEY_COMMA , KEY_PERIOD    , KEY_SLASH , NOP       , NOP     , NOP           , NOP , NOP , NOP  } ,
/* 5 */  { NOP       , NOP   , NOP    , NOP    , NOP    , NOP    , NOP   , KEY_SPACE , NOP    , NOP       , NOP           , NOP       , NOP       , NOP     , NOP           , NOP , NOP , NOP  }
};
